...
namespace SpacetimeDB.Types
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        ...
        {
            AddTable(Board = new(conn));
            AddTable(Stroke = new(conn));
        }
    }
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override Reducer ToReducer(TransactionUpdate update)
        {
            ...
            {
                "add_stroke" => BSATNHelpers.Decode<Reducer.AddStroke>(encodedArgs),
                "clear_board" => BSATNHelpers.Decode<Reducer.ClearBoard>(encodedArgs),
                "create_board" => BSATNHelpers.Decode<Reducer.CreateBoard>(encodedArgs),
                "delete_stroke" => BSATNHelpers.Decode<Reducer.DeleteStroke>(encodedArgs),
                "delete_stroke_anyone" => BSATNHelpers.Decode<Reducer.DeleteStrokeAnyone>(encodedArgs),
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.AddStroke args => Reducers.InvokeAddStroke(eventContext, args),
                Reducer.ClearBoard args => Reducers.InvokeClearBoard(eventContext, args),
                Reducer.CreateBoard args => Reducers.InvokeCreateBoard(eventContext, args),
                Reducer.DeleteStroke args => Reducers.InvokeDeleteStroke(eventContext, args),
                Reducer.DeleteStrokeAnyone args => Reducers.InvokeDeleteStrokeAnyone(eventContext, args),
