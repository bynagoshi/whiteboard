...
pub mod add_stroke_reducer;
pub mod board_table;
pub mod board_type;
pub mod clear_board_reducer;
pub mod create_board_reducer;
pub mod delete_stroke_anyone_reducer;
pub mod delete_stroke_reducer;
...
pub use add_stroke_reducer::{add_stroke, set_flags_for_add_stroke, AddStrokeCallbackId};
pub use board_table::*;
pub use board_type::Board;
pub use clear_board_reducer::{clear_board, set_flags_for_clear_board, ClearBoardCallbackId};
pub use create_board_reducer::{create_board, set_flags_for_create_board, CreateBoardCallbackId};
pub use delete_stroke_anyone_reducer::{
    delete_stroke_anyone, set_flags_for_delete_stroke_anyone, DeleteStrokeAnyoneCallbackId,
};
pub use delete_stroke_reducer::{
    delete_stroke, set_flags_for_delete_stroke, DeleteStrokeCallbackId,
};
...
pub use stroke_table::*;
pub use stroke_type::Stroke;
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::AddStroke { .. } => "add_stroke",
            Reducer::ClearBoard { .. } => "clear_board",
            Reducer::CreateBoard { .. } => "create_board",
            Reducer::DeleteStroke { .. } => "delete_stroke",
            Reducer::DeleteStrokeAnyone { .. } => "delete_stroke_anyone",
...
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(value: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> __sdk::Result<Self> {
        match &value.reducer_name[..] {
            "add_stroke" => Ok(
                __sdk::parse_reducer_args::<add_stroke_reducer::AddStrokeArgs>(
                    "add_stroke",
                    &value.args,
                )?
                .into(),
            ...
            "clear_board" => Ok(
                __sdk::parse_reducer_args::<clear_board_reducer::ClearBoardArgs>(
                    "clear_board",
                    &value.args,
                )?
                .into(),
            ...
            "create_board" => Ok(
                __sdk::parse_reducer_args::<create_board_reducer::CreateBoardArgs>(
                    "create_board",
                    &value.args,
                )?
                .into(),
            ),
            "delete_stroke" => Ok(__sdk::parse_reducer_args::<
                delete_stroke_reducer::DeleteStrokeArgs,
            >("delete_stroke", &value.args)?
            .into()),
            "delete_stroke_anyone" => Ok(__sdk::parse_reducer_args::<
                delete_stroke_anyone_reducer::DeleteStrokeAnyoneArgs,
            >("delete_stroke_anyone", &value.args)?
            .into()),
...
pub struct DbUpdate {
    ...
    stroke: __sdk::TableUpdate<Stroke>,
}
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                ...
                "stroke" => db_update
                    .stroke
                    .append(stroke_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.stroke = cache
            .apply_diff_to_table::<Stroke>("stroke", &self.stroke)
            .with_updates_by_pk(|row| &row.id);
...
pub struct AppliedDiff<'r> {
    ...
    stroke: __sdk::TableAppliedDiff<'r, Stroke>,
}
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<Stroke>("stroke", &self.stroke, event);
    }
}
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        ...
        stroke_table::register_table(client_cache);
    }
}
